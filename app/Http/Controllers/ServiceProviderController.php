...
class ServiceProviderController extends Controller
{
    ...
    public function GetOrderDetails($id)
    {
        ...
        ->leftjoin('users','users.id','=','orders.customer_id')->select('users.*','orders.id as order_id','orders.status as order_type','deals.service_title','orders.scheduleDate','orders.total_amount','orders.note')
